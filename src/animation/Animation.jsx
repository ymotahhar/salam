...
import {
  ...
  AnimationImg,
  AnimationItem,
  SelectedAnimationItem,
  SelectedAnimationTitle,
  GenereList,
  Genere, AnimationDetail, AnimationTitr, FreeLable, CloseAnimation
} from "./Animation.styled";
import SelectedAnimData from "./animationfilmdata/SelectedAnimFilmData"
...
export default function Animation() {
  ...
  useEffect(() => {
    axios.get("https://moviesapi.ir/api/v1/genres/15/movies?page=1").then((res) =>
      setAnimationList(res.data.data));
    // {
    //   "id": 1,
    ...
    <div >
      ...
      >
        <AnimationList>
          ...
          {animationList.map((film) => {
            return (<SwiperSlide>

              <AnimationItem className="freelable">
                <div
                  onMouseEnter={() => {
                ...
                >
                  ...
                  <AnimationTitle>{film.title}</AnimationTitle>
                </div>
              </AnimationItem>
            </SwiperSlide>
      ...
      {
        selectedAnimation && (
          <SelectedAnimationItem showAnimation={isVisibleAnimation} >
            <SelectedAnimData idAnim={selectedAnimation.id}></SelectedAnimData>
            <CloseAnimation onClick={closeanimation}   ></CloseAnimation>
            <img src={selectedAnimation.poster}></img>
            {/* <SelectedAnimationTitle>{selectedAnimation.title}</SelectedAnimationTitle>
            <GenereList> genere : {selectedAnimation.genres.map((gen) => {
