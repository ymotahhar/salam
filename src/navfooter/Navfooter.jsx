...
import { Logo } from './advertising/Advertising.styled'
import { BrowserRouter, Link, Route, Routes } from "react-router-dom"
import Advertis from "./advertising/Advertising";
export default function Navfooter() {
  function click1() {
    document.querySelector(".cwindow").style.display = "block"
    document.querySelector(".yas").style.display = "none"
    closeNav();
  }
  function click() {
    document.querySelector(".cwindow").style.display = "none"
    document.querySelector(".yas").style.display = "block"
  }
  window.onscroll = function () { myFunction() };
  function myFunction() {
    if (document.body.scrollTop > 2500 || document.documentElement.scrollTop > 2500) {
      document.getElementById("nav").className = "navfix";
    } else {
      document.getElementById("nav").className = "navFooterWrpper";
    }
  }
